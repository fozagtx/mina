  ...
  if (loading || !isClient) {
    return (
      <div className="flex items-center justify-center p-8">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-bimboh-primary"></div>
    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="w-32 bg-black/20 border-bimboh-primary/20">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="border-bimboh-primary/30 text-bimboh-primary"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-black/20 border-bimboh-primary/20">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-bimboh-primary">{analytics.totalVideos}</p>
        ...
        <Card className="bg-black/20 border-bimboh-primary/20">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-bimboh-primary">{formatNumber(analytics.totalViews)}</p>
            <p className="text-xs text-muted-foreground mt-1">
              Combined reach
            </p>
          </CardContent>
        ...
        <Card className="bg-black/20 border-bimboh-primary/20">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-bimboh-primary">{analytics.totalMentions}</p>
            <p className="text-xs text-muted-foreground mt-1">
              Token references
            </p>
          </CardContent>
        ...
        <Card className="bg-black/20 border-bimboh-primary/20">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-bimboh-primary">{formatNumber(analytics.totalComments)}</p>
            <p className="text-xs text-muted-foreground mt-1">
              User engagement
            </p>
          </CardContent>
            ...
            {analytics.topTokens.map((token, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-black/10 rounded-lg">
                <div className="flex items-center gap-3">
                  <Badge variant="outline" className="border-bimboh-primary/30 text-bimboh-primary">
                    {token.symbol}
                  </Badge>
          ...
          <div className="space-y-3">
            {analytics.recentActivity.map((activity, index) => (
              <div key={index} className="flex items-center gap-3 p-3 bg-black/10 rounded-lg">
                <div className="w-2 h-2 bg-bimboh-primary rounded-full"></div>
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <Input
                ...
                className="bg-black/20 border-bimboh-primary/20 text-white placeholder:text-muted-foreground"
              />
            </div>
            <Button
              variant="outline"
