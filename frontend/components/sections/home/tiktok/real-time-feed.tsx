      ...
      {!loading && filteredTiktoks.length > 0 && (
        ...
        {filteredTiktoks.slice(0, visibleVideos).map((tiktok) => {
          ...
          return (
              <Card
                key={tiktok.id}
                className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-bimboh-primary/50 transition-all duration-300 hover:scale-105"
              >
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-bimboh-primary to-bimboh-secondary rounded-full flex items-center justify-center text-black font-bold text-sm">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <TrendingUp className="h-4 w-4 text-bimboh-primary" />
                </div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {tiktokMentions.map((mention) => (
                        <Badge
                          key={mention.id}
                          variant="secondary"
                          className="bg-bimboh-primary/20 text-bimboh-primary border-bimboh-primary/30"
                        >
                ...
                <Button
                  asChild
                  className="w-full bg-bimboh-primary hover:bg-bimboh-primary/80 text-black"
                  size="sm"
                >
      ...
      {!loading && filteredTiktoks.length === 0 && !error && (
        <div className="text-center py-12">
          <div className="w-16 h-16 bg-bimboh-primary/20 rounded-full flex items-center justify-center mx-auto mb-4">
            <TrendingUp className="h-8 w-8 text-bimboh-primary" />
          </div>
