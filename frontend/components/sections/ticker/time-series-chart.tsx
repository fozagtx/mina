      ...
      <CardHeader className="space-y-4 p-4 sm:p-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center">
            ...
            />
            <CardTitle className="text-lg sm:text-xl font-bold text-bimboh-primary nouns tracking-widest">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sen">
          <div className="flex items-center space-x-2">
            <Switch
              ...
              id="price-toggle"
              className="bg-bimboh-primary data-[state=checked]:bg-bimboh-primary"
            />
            <div
